			...
			<div class="col-sm-2">
				<div class="btn-group dropright mr-3">
					<button type="button"
						...
						data-toggle="dropdown">축제정보</button>
			...
			<div class="col-sm-2">
				<div class="btn-group dropright">
					<button type="button"
						...
						data-toggle="dropdown">공연정보</button>
					<div class="dropdown-menu">
						...
						<a class="dropdown-item" href="#"
							onclick="chkProductAreaCode(31);">경기</a> <a class="dropdown-item"
							href="#" onclick="chkProductAreaCode(2);">인천</a> <a
							class="dropdown-item" href="#" onclick="chkProductAreaCode(34);">충남</a>
						<a class="dropdown-item" href="#"
							onclick="chkProductAreaCode(33);">충북</a> <a class="dropdown-item"
							href="#" onclick="chkProductAreaCode(3);">대전</a> <a
							class="dropdown-item" href="#" onclick="chkProductAreaCode(8);">세종</a>
						<a class="dropdown-item" href="#"
							onclick="chkProductAreaCode(32);">강원</a> <a class="dropdown-item"
							href="#" onclick="chkProductAreaCode(38);">전남</a> <a
							class="dropdown-item" href="#" onclick="chkProductAreaCode(37);">전북</a>
						...
						<a class="dropdown-item" href="#"
							onclick="chkProductAreaCode(36);">경남</a> <a class="dropdown-item"
							href="#" onclick="chkProductAreaCode(35);">경북</a> <a
							class="dropdown-item" href="#" onclick="chkProductAreaCode(6);">부산</a>
						<a class="dropdown-item" href="#"
							onclick="chkProductAreaCode(39);">제주</a>
					</div>
				</div>
			</div>
		</div>
